...
ITEMS = [
    ...
    dict(
        ...
        title="F45 지점 관리",
        purpose="전국 67개 지점 지도 + 협의 현황표 + 지점별 판매링크·QR 생성 + 할인코드 기록 + 신청 접수내역. F45 작업의 본진.",
        url="https://company-dari.github.io/darimati-dash/f45/",
        owner="지운",
        meta="PIN 필요 · 입력값은 브라우저에 저장(localStorage) — 기기 바꾸면 앱 안 '백업 내보내기'로 옮기기",
        tags="f45 지점 지도 트래커 영업 협의 타깃 map 67 링크 utm qr 할인코드 신청",
    ),
    dict(
        cat="f45", kind="web", status="live",
    ...
    dict(
        ...
        title="인물 관리 (선수·크리에이터·파트너·코치)",
        purpose="다리마티가 관리하는 사람을 4그룹(DARIMATI ATHLETE/CREATOR/PARTNER/COACH)×티어로 분류. 티어별 대우(주는 것/받는 것) 정의 + 연락처·채널·사이즈/배송지·성적·계약·활동이력을 대시보드 안에서 직접 수정.",
        url="https://company-dari.github.io/darimati-dash/talent/",
        owner="지운",
        meta="PIN 필요 · 실명·계약금이 들어가 브라우저에만 암호화 저장(기기별) — 기기 바꾸면 앱 안 '내보내기/불러오기' · 승격은 수동",
        tags="인물 선수 크리에이터 파트너 코치 athlete creator partner coach 앰버서더 계약 섭외 티어 talent",
    ),
    dict(
        cat="brand", kind="web", status="live",
        title="레디키트 셀프 수령확인 (참가자 QR)",
        purpose="8/1 부스에서 참가자가 직접 여는 화면. 이름+전화 뒷4자리로 본인 확인 → 부스코드 입력 → 수령 확인 → 완료 화면을 포토존 직원에게 제시. 매니저 개입 없음.",
        url="https://company-dari.github.io/darimati-dash/pickup/",
        owner="지운",
        meta="이 주소를 QR로 인쇄 · 사전신청 명단(Klaviyo)은 5분마다 자동 동기화",
        tags="rextreme 렉스트림 레디키트 수령 확인 qr 부스 픽업 pickup 셀프",
    ),
    dict(
        cat="brand", kind="web", status="live",
        title="레디키트 수령 운영 (매니저)",
        purpose="실시간 수령 현황·남은 수량·명단 검색. 대신 수령확인/취소, 명단에 없는 사람 현장등록, 부스코드 변경, 수령 마감 스위치, CSV 내보내기.",
        url="https://company-dari.github.io/darimati-dash/pickup/admin/",
        owner="지운",
        meta="기기별 최초 1회 암호 입력 · 인쇄용 QR 포스터도 여기서 열림",
        tags="rextreme 레디키트 수령 운영 매니저 현황 현장등록 부스코드 csv",
    ),
    dict(
        cat="brand", kind="web", status="live",
...
LAST = {
    ...
    "인물 관리 (선수·크리에이터·파트너·코치)": ("2026-07-22", "밝은 테마 + 상세항목 20개(사이즈·배송지·성적·계약서링크)로 확장 · 초기 5명"),
    "F45 지점 관리":                 ("2026-07-22", "페이지 2개로 갈라진 것 잠금판으로 통합 · 공개 트래커는 내림 · 신청접수는 구글쪽 작업 남음"),
